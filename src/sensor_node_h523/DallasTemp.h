...
// PB0 — unchanged from the F103 build. Free GPIO on both parts; PB0 is also
// TIM3_CH3-capable on the H523 but that channel is unused (only CH4/PB1 for
// the pump), so there's no conflict using it as a plain digital pin here.
